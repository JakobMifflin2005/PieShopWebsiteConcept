...
<body class="w3-blue">
    ...
    <section class="w3-content w3-section">
        <h3 class="w3-xlarge w3-center">What do we offer?</h3>
        <ul>
            <li>Multiple flavors of homemade pies including favorites like</li>
            <ol>
                <li>Pumpkin Pie</li>
                <li>Pecan Pie</li>
                <li>Apple Pie</li>
            </ol>
            <li>Fresh Ingredients — We use only the freshest, locally sourced ingredients in every pie.</li>
            <li>Seasonal Specials — Limited-time pies for holidays and seasons (like Strawberry Rhubarb in summer, Peppermint Pie for Christmas).</li>
            <li>Excellent Customer Service inside the resturant and outside the resturant</li>
            <li>Warm, Cozy Atmosphere — Enjoy your pie in a friendly and welcoming environment.</li>
    </section>
    <section class="w3-content w3-section" style="max-width: 500px;">
        <h3 class="w3-center">Look at our Pies!</h3>
        <img class="mySlides w3-animate-top" src="img/apple.png" alt="nice, juicy apple pie" style="height: 300px;">>
        <img class="mySlides w3-animate-bottom" src="img/cherry.png" alt="nice, juicycherry pie" style="height: 300px;">>
        <img class="mySlides w3-animate-top" src="img/pecan.png" alt="nice, juicy pecan pie" style="height: 300px;">>
        <img class="mySlides w3-animate-bottom" src="img/julypie.png" alt="nice, juicy limited edition 4th of July pie" style="height: 300px;">>
        <script>
var myIndex = 0;
carousel();
...
function carousel() {
  ...
  setTimeout(carousel, 2500);    
        ...
        <p>Look appitizeing? Click <a href="shoppingcart.php">here</a> to order a pie!</p>
    </section>
    <section>
